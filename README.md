...
PES_AUTHOR="s spandana  <PES2UG24AM140>"
...
### Screenshots
![alt text](<WhatsApp Image 2026-04-17 at 13.04.45.jpeg>)
...
2. 2. Load the commit object and extract its tree hash
...
1. *Grace period:* Git's GC doesn't delete objects immediately. Objects must be unreachable AND older than a threshold (default: 2 weeks for loose objects). This makes it extremely unlikely that a just-created object g1.  gets deleted.
...
bash
export PES_AUTHOR="s spadana <PES2UG24AM140>" && ./pes [command]
